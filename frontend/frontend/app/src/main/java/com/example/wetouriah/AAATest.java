...
public class AAATest extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_aaatest);
        //mWarehouses("");
        //houseAddresses = createHouseAddresses();
    ...
    private LatLng getLocationFromAddress(String location) {
        ...
        Geocoder geocoder = new Geocoder(AAATest.this);
        try {
