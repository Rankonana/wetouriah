...
public class AllWarehousesViewHolder extends RecyclerView.ViewHolder  {



    ImageView image;

    TextView address,volume,operating_hours;

    CheckBox cctv,armed_response,parking_space,fire_safety_and_management,is_approved;

    public AllWarehousesViewHolder(@NonNull View itemView) {
        super(itemView);
